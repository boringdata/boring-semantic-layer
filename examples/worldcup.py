...
matches = (
    ...
    .join_one(tournament_dimensions, on="tournament_id", how="left")
    .join_one(stadium_dimensions, on="stadium_id", how="left")
)
...
team_appearances = (
    ...
    .join_one(team_dimensions, on="team_id", how="left")
    .join_one(tournament_dimensions, on="tournament_id", how="left")
)
