...
This directory contains BSL v2 recreations of popular Malloy semantic models from the [malloy-samples](https://github.com/malloydata/malloy-samples) repository.

## Overview

The goal of these recreations is to demonstrate how BSL v2 can handle the same complex analytical use cases as Malloy, showcasing feature parity and ergonomic similarities between the two semantic layer approaches.
