...
def _lower_semantic_filter(node: SemanticFilter, catalog, *args):
    from boring_semantic_layer.semantic_api.ops import SemanticAggregate, _get_merged_fields
...
def _lower_semantic_project(node: SemanticProject, catalog, *args):
    from boring_semantic_layer.semantic_api.ops import _get_merged_fields
