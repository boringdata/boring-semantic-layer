...
class TestRenamedDimensions:
    """Test joins when dimension names differ from column names (issue #43)."""

    def test_join_one_with_renamed_dimension(self, con):
    ...
    def test_join_many_with_renamed_dimension(self, con):
    ...
    def test_flexible_join_with_renamed_dimension(self, con):
