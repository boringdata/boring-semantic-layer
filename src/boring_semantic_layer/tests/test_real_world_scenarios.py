    ...
    def test_lead_time_analysis(self, supply_chain_data):
        ...
        result = (
            ...
            .mutate(
                ...
                avg_lead_time_days=lambda t: xibis.literal(
                    5.5,
    ...
    def test_moving_average_calculation(self, time_series_data):
        ...
        result = (
            ...
            .mutate(
                ...
                .mean()
                .over(xibis.window(order_by="date", preceding=2, following=0)),
                ma_6=lambda t: t["total_value"]
                .mean()
                .over(xibis.window(order_by="date", preceding=5, following=0)),
            )
            .order_by("date")
            .execute()
        )
